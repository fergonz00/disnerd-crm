      ...
      {open&&(
        <div style={{padding:16}}>
          ...
          <div style={{background:"#fff9fc",borderRadius:12,padding:"10px 14px",marginBottom:12}}>
            ...
            <CheckRow checked={!!pkg.multipassListo} onChange={()=>set("multipassListo",!pkg.multipassListo)} label="Multipass listo"/>
          </div>
          ...
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",paddingTop:14,paddingBottom:8,gap:8}}>
            <div style={{display:"flex",alignItems:"center",gap:10,flexShrink:0}}>
              ...
              <div>
                ...
                <div style={{fontSize:10,fontWeight:800,color:syncColor}}>{syncLabel}</div>
              </div>
            </div>
          ...
          <div>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:10}}>
              {tareasHoy.map((t,i)=>{
                ...
                return(
                  <div key={i} style={{background:bg,borderRadius:16,padding:"16px 18px",border:"2px solid "+border,display:"flex",alignItems:"flex-start",gap:14}}>
                    <div style={{fontSize:26,flexShrink:0}}>{t.emoji}</div>
                    <div style={{flex:1}}>
                      <div style={{fontWeight:900,fontSize:14,color:"#3d0026",marginBottom:3}}>{t.titulo}</div>
                      <div style={{fontSize:12,color:"#ad5c7a",fontWeight:600,marginBottom:10}}>{t.detalle}</div>
                    ...
                    <span style={{width:10,height:10,borderRadius:"50%",background:dot,flexShrink:0,marginTop:4}}/>
                  </div>
                );
              })}
            </div>
